    ...
    <div className="flex bg-white fixed bottom-0 h-14 justify-center z-30 max-w-md w-full">
      ...
      <button className="px-3 py-2 w-1/4 max-w-bar min-w-bar cursor-pointer">
        <span className="inline-flex flex-col w-full justify-center items-center">
          ...
          <span className="font-sans font-light text-xs text-bar">Space</span>
        </span>
      </button>
      <button className="px-3 py-2 w-1/4 max-w-bar min-w-bar cursor-pointer">
        <span className="inline-flex flex-col w-full justify-center items-center">
          ...
          <span className="font-sans font-light text-xs text-bar">Help</span>
        </span>
      </button>
      <button className="px-3 py-2 w-1/4 max-w-bar min-w-bar cursor-pointer">
        <span className="inline-flex flex-col w-full justify-center items-center">
          ...
          <span className="font-sans font-light text-xs text-bar">Account</span>
        </span>
      </button>
    </div>
  );
